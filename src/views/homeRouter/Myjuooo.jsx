          ...
          <div className="my-mine-info mine-info">
            ...
            <div className="mine-info__main">
              <div className="mine-info__main__head">
                ...
                <span className="mine-info__main__head__name mine-info__main__head__login">
                  登录/注册
                </span>
                <span className="mine-info__main__head__uid">
                  请点击登录<i className="iconfont icon-left"></i>
                </span>
              </div>
              ...
              <div className="mine-info__main__cnt">
                ...
                >
                  <p className="mine-info__main__cnt__item__num mine-info__main__cnt__item__num--no">
                    立即开通
                  </p>
            ...
            <ul className="mine-setting__list">
              ...
              <li className="mine-setting__list__item">
                <a className="mine-setting__list__item--link">
                  ...
                  <p className="mine-setting__list__item__name mine-setting__list__item__name--active">
                    客服帮助
                  </p>
                </a>
              </li>
